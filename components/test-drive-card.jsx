    ...
    <>
      ...
      >
        <div className="flex flex-col sm:flex-row">
          ...
          {showActions && (
            <div className="p-4 border-t sm:border-t-0 sm:border-1 sm:w-1/4 sm:flex flex-col sm:justify-center sm:items-center sm:space-y-2">
              {booking.notes && (
                <div className="bg-gray-50 p-2 rounded text-sm w-fullf">
              ...
              >
                <Link
                  ...
                  className="flex items-cetner justify-center"
                >
                  View Car
