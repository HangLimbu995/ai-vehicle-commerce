  ...
  return (
    <div className="flex lg:flex-col justify-between gap-4">
          ...
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            <SheetTrigger asChild>
              <Button variant="outline" className="flex items-center gap-2">
                ...
                {activeFilterCount > 0 && (
                  <Badge className="ml-1 h-4 w-4 rounded-full p-0 flex items-center justify-center">
                    {activeFilterCount}
                  </Badge>
                )}
              </Button>
            ...
            >
              ...
              <SheetFooter className="sm:justify-between flex-row pt-2 border-t space-x-4 mx-auto">
                <Button
                  type="button"
                  variant="outline"
      ...
      <div className="hidden lg:block sticky top-24">
        <div className="border rounded-lg orverflow-hidden bg-white">
