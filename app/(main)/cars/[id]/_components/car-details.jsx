...
const CarDetails = ({ car, testDriveInfo }) => {
  ...
  const copyToClipboard = () => {
    ...
    toast.success("Link copoied to clipboard");
  };
    ...
    <div>
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div>
          ...
          <div className="text-2xl font-bold text-blur-600">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Card className="mb-6">
              <CardContent className="p-4">
                ...
                <a href="mainto:help@vehiql.in">
                  <Button veriant="outline" className="w-full">
                    Request Info
                  </Button>
                </a>
              </CardContent>
      ...
      <div className="mt-12 p-6 bg-white rounded-lg shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="whitespace-per-line text-gray-700">
              {car.description}
            </p>
          </div>
          <div>
